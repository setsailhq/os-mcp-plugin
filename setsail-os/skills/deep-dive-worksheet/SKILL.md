...
deep dive / client intake), to get a worksheet's link, to change the questions on
one ("remove the X question", "add a question about Y", "reword Z"), or to review
what the client filled in.
...
- `read_worksheet` — full worksheet content (facts, questions, and any answers the client submitted); use for call prep or to review what they filled in.
...
3. **Create, revise, or read:**
   ...
   - To review answers or prep for a call: `read_worksheet` to see the full
     content and what the client has submitted.
